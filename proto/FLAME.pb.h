...
class DiscoveryPacket final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:FLAME_Protocol.DiscoveryPacket) */ {
 public:
  inline DiscoveryPacket() : DiscoveryPacket(nullptr) {}
  explicit constexpr DiscoveryPacket(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  DiscoveryPacket* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<DiscoveryPacket>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyFrom;
  inline void CopyFrom(const DiscoveryPacket& from) {
...
class ControlPacket final :
 ...
 public:
  ...
  explicit constexpr ControlPacket(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  ControlPacket* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class ReviewPacket final :
 ...
 public:
  ...
  ~ReviewPacket() override;
  explicit constexpr ReviewPacket(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  ReviewPacket* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
inline uint32_t DiscoveryResponse::_internal_ipaddress() const {
  return ipaddress_;
}
inline uint32_t DiscoveryResponse::ipaddress() const {
  // @@protoc_insertion_point(field_get:FLAME_Protocol.DiscoveryResponse.ipAddress)
  return _internal_ipaddress();
}
inline void DiscoveryResponse::_internal_set_ipaddress(uint32_t value) {
  
  ipaddress_ = value;
}
inline void DiscoveryResponse::set_ipaddress(uint32_t value) {
